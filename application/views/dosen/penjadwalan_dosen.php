                    ...
                    <table border="1" id="example1" class="table table-bordered table-striped"; width="60%; ">
                        ...
                        <?php foreach ($data as $r){ ?>
                            <tr>
                                ...
                                <td align="center">
                                    <a class="btn btn-warning" href="<?php echo base_url()."Dosen/editpenjadwalan/".$r['ID_Jadwal']; ?>/<?php echo $user['ID_User']; ?>/<?php echo $r['ID_Mk']; ?>">Edit</a>
                            ...
                            <tr>
                                <form method="POST" action='<?php echo base_url()."Dosen/pro_jadwal/";?>'>
                                    <td>
                                        ...
                                        <input class="form-control" type="hidden" name="ID_Dosen" value="<?php echo $user['ID_User']?>">
                                    ...
                                    <td align="center">
                                        ...
                                        <!--<a class="btn btn-primary" href="<?php echo base_url()."Dosen/pro_jadwal/".$r['ID_Mk']; ?>/<?php echo $user['ID_User']; ?>" type="submit">Pilih</a>-->
                                    </td>
                                </form>
                            </tr>
                        <?php } ?>
